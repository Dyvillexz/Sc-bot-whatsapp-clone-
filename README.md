...
‎Procfile
+ 1
Baris yang diubah: 1 penambahan & 0 penghapusan
Nomor baris berkas asli	Nomor baris diff	Perubahan garis diff
@@ -0,0 +1 @@
worker: npm i -g pm2 && pm2 start index.js && pm2 save && pm2 logs
‎app.json
+ 7
Baris yang diubah: 7 penambahan & 0 penghapusan
Nomor baris berkas asli	Nomor baris diff	Perubahan garis diff
@@ -0,0 +1,7 @@
{
	"name": "Dyvilleexz",
	"description": "WhatsApp Bot Using Lib Baileys",
	"repository": "https://github.com/nazedev/naze-md",
	"logo": "https://node-js-sample.herokuapp.com/node.png",
	"keywords": ["multi-device"]
}
‎config.js
+ 78
Baris yang diubah: 78 penambahan & 0 penghapusan
Nomor baris berkas asli	Nomor baris diff	Perubahan garis diff
@@ -0,0 +1,78 @@
/**
...
‎docker-compose.yml
+ 15
Baris yang diubah: 15 penambahan & 0 penghapusan
Nomor baris berkas asli	Nomor baris diff	Perubahan garis diff
@@ -0,0 +1,15 @@
version: "3.9" 
services:
